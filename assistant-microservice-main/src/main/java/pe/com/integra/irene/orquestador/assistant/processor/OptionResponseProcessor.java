...
@Dependent
public class OptionResponseProcessor extends AbstractResponseProcessor<OutputMessageOption> {

    @Override
    public boolean supports(String responseType) {
        return "option".equalsIgnoreCase(responseType);
    }
